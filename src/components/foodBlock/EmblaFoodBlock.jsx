...
export default function EmblaFoodBlock() {
              ...
              <div className="flex w-[100%] py-5 overflow-x-auto gap-[18px] ">
                {foodsList.foods.map((item) => {
                  return (
                    <div
                      key={item.id}
                      className="embla__slide foodItem flex flex-col items-center min-w-[288px] max-w-[300px] min-h-[360px] max-h-[440px] shadow-lg rounded-[16px]"
                    >
